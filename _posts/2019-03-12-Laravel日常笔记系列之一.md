...
![__get](https://archerzdip.github.io/assets/post/20190305122525205.png =500x300)
2.在getAttribute方法中，在`hasGetMutator`方法中判断是否存在该修改器，存在则继续调用修改后值
![在这里插入图片描述](https://archerzdip.github.io/assets/post/20190305123101417.png =620x500)
3.在getAttributeValue方法中， 可以看到先判断是否有`Mutator` 然后在判断是否`Cast`
![在这里插入图片描述](https://archerzdip.github.io/assets/post/20190305123407310.png =600x600)
4.在mutateAttribute方法中可以看出使用「驼峰式」拼接出该方法并调用
![在这里插入图片描述](https://archerzdip.github.io/assets/post/20190305123722439.png =600x300)
...
![在这里插入图片描述](https://archerzdip.github.io/assets/post/20190305125054525.png =500x300)
## 1.4. 属性类型转换
